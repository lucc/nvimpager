...
describe("lua functions", function()
  ...
  describe("tokenize", function()
    ...
    it("simple numbers", function()
      local actual = tokenize("42")
      assert.same({"42"}, actual)
    end)
    ...
    it("recognizes next token after 24 bit color sequences", function()
      local input = "48;2;101;102;103;99"
      local actual = tokenize(input)
      assert.same({"48;2;101;102;103", "99"}, actual)
    end)
    it("two semicolon between proper tokens create an empty token", function()
      local actual = tokenize("12;;13")
      assert.same({"12", "", "13"}, actual)
    end)
